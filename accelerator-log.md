...
```json
{
  ...
  "repositoryPrefix" : "tapacr.azurecr.io/ky-testing-tap-120/apps-12-07-2022-18-24-08-035299319"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [your-registry.io/project->tapacr.azurecr.io/ky...(truncated)]
